...
#ifndef INCLUDED_HSDEC_FRAME_SYNC_IMPL_H
#define INCLUDED_HSDEC_FRAME_SYNC_IMPL_H
...
public:
    frame_sync_impl(uint32_t code, int len, int block_size);
    ~frame_sync_impl();
...
#endif /* INCLUDED_HSDEC_FRAME_SYNC_IMPL_H */
